...
![image-20200630191203318](markdown/整理树形结构数据.assets/image-20200630191203318.png)

![image-20200630191402219](markdown/整理树形结构数据.assets/image-20200630191402219.png)

---

今天恰好需要完成一个接口，将数据组织长树形结构，下面是简化的代码：
